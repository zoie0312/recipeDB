...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Recipe.used_db_ingredients'
        db.add_column(u'recipes_recipe', 'used_db_ingredients',
                      self.gf('django.db.models.fields.CommaSeparatedIntegerField')(default=9999, max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Recipe.used_db_ingredients'
        db.delete_column(u'recipes_recipe', 'used_db_ingredients')
    ...
    models = {
        ...
        u'recipes.recipe': {
            ...
            'used_db_ingredients': ('django.db.models.fields.CommaSeparatedIntegerField', [], {'max_length': '255'}),
